...
<div id="download" class="modal" tabindex="-1" role="dialog" aria-labelledby="downloadsLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h2 id="downloadsLabel" class="admin-h2"><g:message code="download.download.title" default="Downloads"/></h2>
            </div>
                ...
                <form id="downloadForm">
                    ...
                    <fieldset>
                        ...
                        <div style="clear: both; text-align: center;">
                            <br/><input type="submit" value="<g:message code="download.downloadform.button.submit" default="Start Download"/>" id="downloadStart" class="btn btn-default access-data"/>
                        </div>
            ...
            <div class="modal-footer">
                <button class="btn btn-default search-occurrence" data-dismiss="modal" aria-hidden="true"><g:message code="download.button.close" default="Close"/></button>
            </div>
