...
class gsp_gbiftogo_hub_layoutsalt_gsp extends GroovyPage {
...
printHtmlPart(1)
invokeTag('captureMeta','sitemesh',5,['gsp_sm_xmlClosingForEmptyTag':("/"),'name':("description"),'content':("Portail Togolais du GBIF")],-1)
printHtmlPart(1)
invokeTag('captureMeta','sitemesh',6,['gsp_sm_xmlClosingForEmptyTag':(""),'name':("author"),'content':("GBIF Togo")],-1)
printHtmlPart(1)
...
printHtmlPart(3)
invokeTag('stylesheet','asset',17,['src':("alf.css")],-1)
printHtmlPart(1)
invokeTag('javascript','asset',18,['src':("alf.js")],-1)
printHtmlPart(3)
...
public static final long LAST_MODIFIED = 1573077260000L
